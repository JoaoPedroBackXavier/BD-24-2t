...
CREATE TABLE Personagem(
    ...
    personagem_dataDeNascimento number,
    fk_casa INT,
    fk_professor INT,
    fk_Feitico INT,
    foreign key casa references casa(pk_ID_casa),
...
SELECT Personagem.personagem_nome AS aluno, Casa.casa_nome AS casa  FROM Casa, Materia, Professor, Feitico, Personagem
ON personagem.fk_Casa = Casa.pk_ID_Casa;
...
SELECT Personagem.personagem_nome AS aluno, Personagem.personagem_dataDeNascimento AS data_nascimento, Casa.casa_nome AS casa  FROM Casa, Materia, Professor, Feitico, Personagem
ON personagem.fk_Casa = Casa.pk_ID_Casa
WHERE personagem.fk_Casa = 1;
